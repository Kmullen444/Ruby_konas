...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes in an array using a first block var(memo) to store the       result of the memo being passed to the second block var(obj)
  end
  ...
  #   # code to read 'file'
  #
  #   putting in inside of the do makes its it a block var that can't be 
  #   accessed outside of the block
  #
  #   when you put it before it saves the results of the block to that var
  #
