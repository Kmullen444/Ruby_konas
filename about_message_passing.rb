...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Using __send__ is less likely to have been overwritten and it also
    # works on any class regardless of what that classes send will do
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # you could redefine the method to run something anytime the 
